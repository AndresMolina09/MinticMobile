...
class SpecialistFragment : Fragment() {
    ...
    override fun onStart() {
        ...
        originalList = listOf(
            DoctorModel("1", "General", "Jhon Zuñiga", "350+ pacientes", R.drawable.ico_pediatria.toString(),
                5.0, "Medico general, graduado de la Universidad del Cauca"),
            DoctorModel("2", "Odontologia", "Danny Mage", "300+ pacientes", R.drawable.ico_pediatria.toString(),
                4.0, "Medico odontologo, graduado de la Universidad del Cauca"),
            DoctorModel("3", "Pediatria", "Cristian Pinto", "200+ pacientes", R.drawable.ico_pediatria.toString(),
                4.5, "Medico pediatra, graduado de la Universidad del Cauca"),
            DoctorModel("4", "Especialista", "Julio Mellizo", "400+ pacientes", R.drawable.ico_pediatria.toString(),
                5.0, "Medico especialista, graduado de la Universidad del Cauca"),
            DoctorModel("5", "Especialista", "Nicolas Santander", "100+ pacientes", R.drawable.ico_pediatria.toString(),
                3.0, "Medico especialista, graduado de la Universidad del Cauca"),
            DoctorModel("6", "Pediatria", "Jefferson Campo", "50+ pacientes", R.drawable.ico_pediatria.toString(),
                3.5, "Medico pediatra, graduado de la Universidad del Cauca"),
            DoctorModel("7", "Dermatologia", "Edwin Adrada", "200+ pacientes", R.drawable.ico_pediatria.toString(),
                4.5, "Medico dermatologo, graduado de la Universidad del Cauca"),
            DoctorModel("8", "Especialista", "Fernando Campo", "250+ pacientes", R.drawable.ico_pediatria.toString(),
                4.0, "Medico especialista, graduado de la Universidad del Cauca"),
            DoctorModel("9", "Dermatologia", "Laura Chaparro", "150+ pacientes", R.drawable.ico_pediatria.toString(),
